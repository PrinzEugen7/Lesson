...
xset("thickness",2)
xset("font",1,5)
plot(tt,Sh1(1,:),tt,Sh3(1,:),'--'),xgrid(2)
...
ylabel('$\sigma_1\hspace{4pt}$','fontsize',7,'fontname','Times')
...
xset("thickness",2)
xset("font",1,5)
plot(tt,Sh1(2,:),tt,Sh3(2,:),'--'),xgrid(2)
l=legend(["${\rm Symmetrical\hspace{7pt}SMC}$";"${\rm Asymmetrical\hspace{7pt}SMC}$"],1);
l.font_size = 6;
xset("thickness",1)
xlabel('${\rm Time\hspace{4pt}[s]}$','fontsize',6,'fontname','Times')
ylabel('$\sigma_2\hspace{4pt}$','fontsize',7,'fontname','Times')
