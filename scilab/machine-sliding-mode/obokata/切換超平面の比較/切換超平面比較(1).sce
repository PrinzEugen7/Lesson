...
xset("thickness",2)
xset("font",1,5)
plot(Xh1(1,:),Xh1(3,:),Xh3(1,:),Xh3(3,:),'--'),xgrid(2)
l=legend(["${\rm Symmetrical\hspace{7pt}SMC}$";"${\rm Asymmetrical\hspace{7pt}SMC}$"],5);
l.font_size = 6;
xset("thickness",1)
xlabel('$x_1$','fontsize',7,'fontname','Times')
...
xset("thickness",2)
xset("font",1,5)
plot(Xh1(2,:),Xh1(4,:),Xh3(2,:),Xh3(4,:),'--'),xgrid(2)
l=legend(["${\rm Symmetrical\hspace{7pt}SMC}$";"${\rm Asymmetrical\hspace{7pt}SMC}$"],5);
l.font_size = 6;
xset("thickness",1)
xlabel('$x_2$','fontsize',7,'fontname','Times')
